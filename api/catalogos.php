...
$tables = [
    'carreras' => ['table' => 'carreras', 'id' => 'id_carrera', 'fields' => ['clave', 'nombre', 'id_nivel']],
    'niveles' => ['table' => 'nivel', 'id' => 'id_nivel', 'fields' => ['nombre', 'descripcion']],
    'modalidades' => ['table' => 'modalidad', 'id' => 'id_modalidad', 'fields' => ['nombre', 'descripcion']],
    'periodos' => ['table' => 'periodo_escolar', 'id' => 'id_periodo', 'fields' => ['nombre', 'fecha_inicio', 'fecha_fin', 'activo']],
    'semestres' => ['table' => 'semestre', 'id' => 'id_semestre', 'fields' => ['numero', 'nombre']],
    'motivos' => ['table' => 'motivos_bajas', 'id' => 'id_motivo', 'fields' => ['clave', 'descripcion']]
];
...
switch ($accion) {
    ...
    case 'delete':
        ...
        if ($resultado) {
            ...
            // Guarda en bitacora
            registrarEnBitacora('ELIMINAR_CATALOGO', "Registro eliminado de $pestana (ID: $id)");
