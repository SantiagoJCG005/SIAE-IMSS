...
<div class="card">
    <div class="card-body" style="text-align: center; padding: 60px;">
        ...
        <a href="<?= URL_BASE ?>views/jefa/carpetas.php?nueva=1" class="btn btn-primary">
...
<div class="card">
    <form id="formImportar" enctype="multipart/form-data">
        ...
        <div class="card-footer" style="display: flex; justify-content: flex-end; gap: 12px;">
            <a href="<?= URL_BASE ?>views/jefa/carpetas.php" class="btn btn-ghost">Cancelar</a>
...
function mostrarResultado(datos) {
    ...
    document.getElementById('linkVerTabla').href = '<?= URL_BASE ?>views/jefa/tabla.php?id=' + datos.id_tabla;
