...
<link rel="stylesheet" href="<?= URL_RECURSOS ?>css/jefa/tabla.css">
...
// Función para parsear el texto escaneado del NSS
...
//Funcion para inicializar el escáner de NSS en el modal de agregar alumno
    ...
    if (result.isConfirmed) {
        ...
        try {
            ...
            Swal.fire({
                ...
                text: 'El archivo TXT ha sido generado y descargado.',
                icon: 'success'
            }).then(() => {
