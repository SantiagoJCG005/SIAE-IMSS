<?php
/**
 * SIAE-IMSS - Acuses PDF IMSS (Admin Servicios Escolares)
...
<link rel="stylesheet" href="<?= URL_RECURSOS ?>css/admin-se/acuses.css">
    ...
    <div class="card-body">
        ...
        <div class="preview-stats-grid">
            <div class="preview-stat">
                ...
                <div class="preview-stat-label">Total en PDF <span class="tip-icon" data-tip="Número total de NSS en el documento PDF del IMSS, incluyendo duplicados."><i data-lucide="info"></i></span></div>
            ...
            <div class="preview-stat">
                ...
                <div class="preview-stat-label">Encontrados en sistema <span class="tip-icon" data-tip="NSS que sí están registrados en el sistema. Se actualizará su estatus IMSS al confirmar."><i data-lucide="info"></i></span></div>
            </div>
            <div class="preview-stat">
                <div class="preview-stat-num" style="color:#DC2626;" id="statNoEncontrados">0</div>
                <div class="preview-stat-label">No encontrados <span class="tip-icon" data-tip="NSS del PDF que no tienen alumno registrado en el sistema. No se actualiza nada para ellos."><i data-lucide="info"></i></span></div>
            </div>
        </div>
    ...
    tbody.innerHTML = d.acuses.map((a, i) => `
        <tr>
            ...
            <td>
                ...
                <?php if (tieneAlgunRol([ROL_SUPERADMIN, ROL_JEFA_SERVICIOS])): ?>
